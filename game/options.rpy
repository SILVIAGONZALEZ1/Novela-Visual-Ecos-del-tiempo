...
define config.name = _("Ecos del Tiempo")
...
define gui.about = _p("Programa realizado por Cardozo Macarena y Gonzalez Silvia")
...
define build.name = "EcosdelTiempo"
...
define config.save_directory = "EcosdelTiempo-1718049823"
